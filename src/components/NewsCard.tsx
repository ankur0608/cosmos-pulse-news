...
const NewsCard = ({ 
  ...
  return (
    <Card className={`${sizeClasses[size]} group cursor-pointer hover:shadow-lg transition-all duration-300 border-news-border`}>
      <CardContent className="p-0">
        ...
        <div className="p-4">
          <div className="flex items-center justify-between mb-2">
            <Badge variant="outline" className="text-category-tag border-category-tag">
